...
import { useUpdateTenantProfile } from "../../hooks/use-tenant";
import {
  useGetUploadUrl,
  useUploadFile,
...
export function UpdateProfile({
  ...
  const updateAvatar = useUpdateTenantProfile();
      ...
      <DialogTrigger asChild>
        <div className="relative group cursor-pointer inline-block rounded-full">
          <Avatar className="h-24 w-24 border-2 border-border transition-opacity group-hover:opacity-80">
            ...
            <AvatarFallback className="text-xl">{tenantName[0]}</AvatarFallback>
          </Avatar>
